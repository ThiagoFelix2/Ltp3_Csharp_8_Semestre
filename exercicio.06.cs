...
class Program
{
    static void Main()
    {
        ...
        while (true)
        {
            ...
            Console.WriteLine("1. Realizar uma transferencia");
            ...
            if (escolha == 1)
            {
                Console.WriteLine("Digite o nome do beneficiario:");
                ...
                if (beneficiario.ToLower() == "joao" || beneficiario.ToLower() == "maria")
                {
                    ...
                    {
                        Console.WriteLine("O valor da transferencia deve ser maior que zero.");
                    }
                    ...
                    else
                    {
                        ...
                        Console.WriteLine($"Transferencia de {valorTransferencia:C2} para {beneficiario} realizada com sucesso!");
                        Console.WriteLine($"Saldo atual de Joao: {contaJoao:C2}");
                        Console.WriteLine($"Saldo atual de Maria: {contaMaria:C2}");
                    }
                }
                else
                {
                    Console.WriteLine("Beneficiario não encontrado. Verifique o nome e tente novamente.");
                }
            }
            else if (escolha == 2)
            {
                Console.WriteLine("Obrigado por usar o sistema de transferencia PIX. Adeus!");
                break;
            }
            else
            {
                Console.WriteLine("Opção invalida. Por favor, escolha 1 para realizar uma transferência ou 2 para sair.");
            }
        }
    }
}
